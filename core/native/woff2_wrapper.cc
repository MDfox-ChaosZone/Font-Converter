...
extern "C" size_t font_converter_google_max_compressed_size(
    const uint8_t* input,
...
extern "C" int font_converter_google_convert(
    const uint8_t* input,
    size_t input_length,
    uint8_t* output,
...
extern "C" size_t font_converter_google_decompressed_size(
    const uint8_t* input,
    size_t input_length) noexcept {
  if (input == nullptr || input_length == 0) {
    return 0;
...
extern "C" int font_converter_google_decompress(
    const uint8_t* input,
    size_t input_length,
    uint8_t* output,
