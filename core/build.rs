...
fn build_google_woff2() {
    ...
    woff2.compile("font_converter_google_woff2");
    ...
    encoder.compile("font_converter_brotli_encoder");
    ...
    decoder.compile("font_converter_brotli_decoder");
    ...
    common.compile("font_converter_brotli_common");
